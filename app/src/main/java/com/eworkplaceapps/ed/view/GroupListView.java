...
public class GroupListView extends ExpandableListView {
     ...
     * to onFollowUpClick all of it's view. This time however, depending on whether a
     ...
     * ExpandableListView to onFollowUpClick all views on screen. The way that
     ...
     * the ExpandableListView is forced to onFollowUpClick it's views again, except this
     ...
     * 9. This forces the ExpandableListView to onFollowUpClick all of it's views again.
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Force the listview to onFollowUpClick it's views
    ...
    /**
     * A specialized adapter for use with the MyTeamsListView. All
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private GroupListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(GroupListView parent) {
            this.parent = parent;
        }
